package com.demo.kafkaProducer.security.jwt;

import static com.demo.kafkaProducer.security.SecurityUtils.AUTHORITIES_KEY;
import static com.demo.kafkaProducer.security.SecurityUtils.JWT_ALGORITHM;
