package com.demo.kafka.web.rest;

import com.demo.kafka.repository.ProducerRepository;
import com.demo.kafka.service.ProducerService;
import com.demo.kafka.service.dto.ProducerDTO;
import com.demo.kafka.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.demo.kafka.domain.Producer}.
 */
@RestController
